<div class="modal fade" id="edit_room{{$room->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method='post' action='edit-room/{{$room->id}}' onsubmit='show();'  enctype="multipart/form-data">
            <div class="modal-body">
            
                    {{ csrf_field() }}
                <label >Title</label>
                <input name='name' class='form-control mb-2 mr-sm-2' value='{{$room->name}}' type='text' required>
