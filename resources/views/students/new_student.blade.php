<div class="modal fade" id="new_student" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method='post' action='new-student' onsubmit='show();'  enctype="multipart/form-data">
                    ...
                    <div class='col-md-6 border-right'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-6'> 
                                ...
                                <input name='student_id' class='form-control mb-2 mr-sm-2' type='text' required>
                                <label >Course
                                    
                                </label>
                                <input name='course' class='form-control mb-2 mr-sm-2' type='text' required>
                                <label >Email</label>
